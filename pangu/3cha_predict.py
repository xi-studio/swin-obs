...
class Radars(Dataset):
    ...
    def __getitem__(self, index):
        ...
        pred_input  = np.concatenate((sate, pred[(0,2,3),:,:]), axis=0)

        return pred_input, obs[(0,2,3),:,:]
...
def training_function(config):
    ...
    accelerator.load_state('logs/epoch_254')
...
def main(): 
    config = {"lr": 4e-5, "num_epochs": 1, "seed": 42, "batch_size": 10, "in_channels": 13, "mul_channels":128}
