...
def training_function(config):
    ...
    accelerator.init_trackers("log_1219", config=hps)
    ...
    for epoch in range(epoch_num):
        ...
        if epoch > 250:
            accelerator.save_state(f"./logs_pangu/checkpoint_1219/epoch_{epoch}")
        if eval_metric < best_acc:
            best_acc = eval_metric
            accelerator.save_state("./logs_pangu/checkpoint_1219/best")
