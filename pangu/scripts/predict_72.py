...
def main():
    ...
    sur  = surface_data.sel(time=slice('2020-01-01', '2021-12-31'), latitude=slice(60.0, 0.0), longitude=slice(70.0, 140.0))
    hig  = high_data.sel(time=slice('2020-01-01', '2021-12-31'), latitude=slice(60.0, 0.0), longitude=slice(70.0, 140.0))
    ...
    for i, _ in enumerate(res_sur):
        ...
        np.savez('./pangu_2020_2021/%s.npz' % now, sur=sur, upper=high)
        print('save', now)
